...
export default function ProjectMainHub(props: ProjectMainHubProps) {
  ...
  return (
    <div className=" md:w-5/6 w-full max-w-6xl flex flex-col items-center dark:bg-[#1a202c] dark:border-gray-700 border border-gray-200 rounded-lg shadow-lg p-2 truncate">
