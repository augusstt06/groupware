...
export default function ProjectDetailTodoCard(props: ProjectDetailTodoCardPRops) {
  return (
    <div className="grid grid-cols-4 gap-2  dark:border-gray-700 border border-gray-200 rounded-lg dark:bg-[#1a202c] shadow-lg h-12 mb-2">
      <div className="col-span-2 md:col-span-1 grid grid-cols-8">
        <div className="col-span-1 bg-indigo-400 rounded-l-lg"></div>
        <div className="col-span-7 grid grid-cols-4">
          <div className="col-span-2 md:col-span-1 items-center flex justify-center">
      ...
      <div className="md:col-span-1 md:inline hidden bg-gray-200"></div>
      <div className="col-span-2 md:col-span-2 grid grid-cols-4  bg-cyan-300 truncate">
