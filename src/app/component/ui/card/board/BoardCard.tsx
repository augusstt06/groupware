...
export default function BoardCard() {
  ...
  return (
    <div className="w-full max-w-sm border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-5">
      ...
      <div className="flex flex-col items-center pb-4">
        ...
        <div className="flex flex-start justify-between w-4/5 mb-1">
          <span className="md:text-base text-xs text-gray-500 dark:text-gray-400">내가 쓴 글</span>
          <span className="md:text-base text-xs text-white-400 font-bold">0</span>
        </div>

        <div className="flex flex-start justify-between w-4/5 mb-1">
          <span className="md:text-base text-xs text-gray-500 dark:text-gray-400">작성중인 글</span>
          <span className="md:text-base text-xs text-white-400 font-bold">0</span>
        </div>
