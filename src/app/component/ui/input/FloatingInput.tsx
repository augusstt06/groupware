...
import { type FloatingInputProps } from '@/app/types/ui/inputTypes'
  ...
  const renderViewContentIcon = () => {
    if (isViewActive) {
      if (inputViewType === 'password') {
        return (
          <IoMdEye
            className="absolute transition ease-in-out duration-500 cursor-pointer hover:scale-125 top-3.5 right-2"
