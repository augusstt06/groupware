...
export const REGISTER_EMAIL_EN = 'E-Mail'
export const REGISTER_PWD = '비밀번호'
export const REGISTER_PWD_EN = 'Password'
export const REGISTER_CONFIRM_PWD = '비밀번호 확인'
export const REGISTER_CONFIRM_PWD_EN = 'Confirm Password'
export const REGISTER_NAME = '이름'
export const REGISTER_NAME_EN = 'Name'
export const REGISTER_PHONENUMBER = '전화번호'
export const REGISTER_PHONENUMBER_EN = 'Phone Number'
export const REGISTER_POSITION = '직무'
export const REGISTER_POSITION_EN = 'Position'
export const REGISTER_ORG_NAME = '조직 이름'
export const REGISTER_ORG_NAME_EN = 'Organization Name'
export const REGISTER_ORG_DESCRIPTION = '조직 설명'
export const REGISTER_ORG_DESCRIPTION_EN = 'Description'
export const REGISTER_ORG_JOIN = '조직 코드'
export const REGISTER_ORG_JOIN_EN = 'Organization Code'
