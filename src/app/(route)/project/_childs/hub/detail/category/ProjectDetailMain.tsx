...
import InviteProjectMemberTable from '@/components/table/project/InviteProjectMemberTable'
import ProjectDetailTable from '@/components/table/project/ProjectDetailTable'
