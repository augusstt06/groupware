...
import { MODAL_CREATE_PROJECT_ISSUE, MODAL_INVITE_MEMBER_IN_PROJECT } from '@/_constant/constant'
import { type ModalHubProps, type ModalUsePortalProps } from '@/_types/module'
import { type ModalBtnProps } from '@/_types/ui/modal'
...
export function Modal(props: ModalUsePortalProps) {
  ...
  const viewModal = () => {
    ...
    return ReactDOM.createPortal(
      ...
      >
        <div
          className={`p-3 relative rounded-lg shadow bg-[#f5f7fc] dark:bg-[#2e2e2e] backdrop-blur-3xl border-solid border-4 border-indigo-300 w-5/6 md:w-1/2 xl:w-2/5 2xl:w-3/12 `}
        >
          {props.children}
