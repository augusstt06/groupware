...
export default function ProjectCard(props: ProjectCardProps) {
  ...
  return (
    <div
      className="w-32 h-24 bg-white border-gray-300 shadow-2xl smooth-transition sort-row-flex dark:bg-gray-100 dark:text-black 2xl:w-44 xl:w-48 md:w-48 border-1 hover:scale-110 hover:shadow-2xl"
